 ...
 */
package com.mole.afloat.permission.rom;
...
//            intent.setClassName("com.meizu.safe", "com.meizu.safe.security.AppSecActivity");//remove this line code for fix flyme6.3
            ...
            try {
                LogUtil.e("获取悬浮窗权限, 打开AppSecActivity失败, " + Log.getStackTraceString(e));
                // 最新的魅族flyme 6.2.5 用上述方法获取权限失败, 不过又可以用下述方法获取权限了
                PermissionUtil.commonROMPermissionApplyInternal(context);
            } catch (Exception eFinal) {
                LogUtil.e("获取悬浮窗权限失败, 通用获取方法失败, " + Log.getStackTraceString(eFinal));
            }
        }
